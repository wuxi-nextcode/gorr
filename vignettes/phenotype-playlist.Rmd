...
First we'll need to establish a connection to our API services. To do that we'll need to call `gor_connect` and provide it with the relevant parameters pointing to the phenotype-catalog-service, i.e. `api_key` and `project`:

---
title: "Exploring phenotype services"
...
```{r}
phenotype <- get_phenotype(name = phenotypes[1], conn)
print(phenotype[1:4])
```
...
result_type <- "QT" # Type of phenotype (either "QT", "SET" or "CATEGORY")
...
```{r, echo=FALSE}
print(paste0('Penotype class: ', class(new_phenotype)))
print(paste0('Penotype name: ',  new_phenotype$name))
print(paste0('Penotype description: ',  new_phenotype$description))
print(paste0('Penotype State: ',  new_phenotype$state))
```
...
We can list all available tags in the catalog using `get_tags` and passing the `gor_connection` object.
